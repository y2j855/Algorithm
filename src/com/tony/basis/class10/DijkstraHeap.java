...
/**
 * @author: Tony.Chen
 * Create Time : 2020/11/26 20:12
 * Description:
 */
public class DijkstraHeap {
    private static final MyGraph.Edge[] GRAPH = {
            ...
            new MyGraph.Edge("a", "b", 7),
            new MyGraph.Edge("a", "c", 9),
            new MyGraph.Edge("a", "f", 14),
            new MyGraph.Edge("b", "c", 10),
            new MyGraph.Edge("b", "d", 15),
            new MyGraph.Edge("c", "d", 11),
            new MyGraph.Edge("c", "f", 2),
            new MyGraph.Edge("d", "e", 6),
            new MyGraph.Edge("e", "f", 9),
    };
